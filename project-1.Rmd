---
title: "The Impact of Socioeconomic Status, Lifestyle Choices, & Demographic Factors on Health: An Exploratory Data Analysis Report"
author: "DATA 350 Group 11: Ademir Ferreyra, Jay Nadkarni, Adrien Rozario"
date: "10/17/2025"
...
### Q2: How do lifestyle choices relate to self-rated health and sleep duration?
...
df <- nhanes_clean %>%
  ...
  dplyr::select(SleepHrsNight, AlcoholDay, SmokeNum, HealthNum) %>%
  na.omit()
...
The correlogram shows that people who smoked were most likely to also consume alcohol, with a positive correlation of around 0.4. Also, notice that smokenum and sleephrsnight had no correlation, which further justifies the finding of our violin plot, which showed no effect on sleep schedule between those who smoked and those who did not. Finally, the variable with the most positive correlations was healthnum. It showed that healthnum had some weak positive correlations with alcohol day (0.3) and smokenum (0.1), meaning that the days you have smoked or consumed alcohol influenced the way people self-reported their health. 
...
**8. Scatter Plot of Sleep vs Age (Faceted by Marital Status, Colored by Gender)**
