...
YouTube Video Presentation: https://youtu.be/7FHjDvoZiik
...
This correlogram shows that people who smoked were most likely to also consume alcohol, with a positive correlation of around 0.4. Also, notice that smokenum and sleephrsnight had no correlation, which further justifies the finding of our violin plot: there was no effect on sleep schedule between those who smoked and those who did not. Finally, the variable with the most positive correlations is healthnum. Healthnum had some weak positive correlations with alcohol day (0.3) and smokenum (0.1), meaning that the days you have smoked or consumed alcohol influenced the way people self-reported their health. 
