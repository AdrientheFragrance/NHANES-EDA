...
3. Grouped bar plot of hard drug use by home ownership
...
g + geom_violin() + labs(x = "Smoking Status", y = "Average sleep duration", title = "Sleep Duration Based on Smoking Status")
```
