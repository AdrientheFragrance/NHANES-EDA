...
g + geom_violin(fill = "lightblue2", alpha = 0.7) + labs(x = "Smoking Status", y = "Average sleep duration", title = "Sleep Duration Based on Smoking Status") 
```
...
g + geom_boxplot(fill = "lightgreen", alpha = 0.7) + coord_flip() +
  labs(title = "Distribution of self-related health by alcohol consumption level", x = "self-reported health", y = "Average Alcohol Use (years)") 
```
